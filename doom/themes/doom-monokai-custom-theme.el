;;; doom-monokai-custom.el --- port of Monokai Classic -*- lexical-binding: t; no-byte-compile: t; -*-
...
(defgroup doom-monokai-custom-theme nil
  "Options for doom-molokai."
  :group 'doom-themes)

(defcustom doom-monokai-custom-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-monokai-custom-theme
  :type 'boolean)

(defcustom doom-monokai-custom-comment-bg doom-monokai-custom-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-monokai-custom-theme
  :type 'boolean)

(defcustom doom-monokai-custom-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-monokai-custom
  ...
  ((bg         '("#272822" nil       nil          ))
   ...
   (selection      base5)
   (builtin        orange)
   (comments       (if doom-monokai-custom-brighter-comments violet base5))
   (doc-comments   (if doom-monokai-custom-brighter-comments (doom-lighten violet 0.1) (doom-lighten base5 0.25)))
   (constants      violet)
   (functions      green)
   (keywords       magenta)
   (methods        green)
   ...
   (-modeline-pad
    (when doom-monokai-custom-padded-modeline
      (if (integerp doom-monokai-custom-padded-modeline) doom-monokai-custom-padded-modeline 4)))
...
;;; doom-monokai-custom.el ends here
