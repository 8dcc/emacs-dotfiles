...
- Configure split direction so new splits are opened to the bottom and to the
  right.
- We set the undo system to =undo-tree=. See [[*Undo tree][Undo tree]] bellow.
...
Instead of treating undo/redo as a linear sequence of changes, =undo-tree-mode=
treats undo history as a branching tree of changes. It allows you to preserve a
complete history of changes, even across sessions. See [[https://www.emacswiki.org/emacs/UndoTree][EmacsWiki]].
...
Major mode for editing TXL files. See [[https://txl.ca/txl-index.html][txl.ca]].
...
[[https://github.com/jart/disaster/issues/31][disaster#31]].
