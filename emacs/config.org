...
popup. We could set it to =#'magit-display-buffer-fullframe-status-v1=, but that
would overwrite our current window layout. We instead use a different method
from [[https://github.com/magit/magit/issues/2541#issuecomment-180611059][magit#2541]].
