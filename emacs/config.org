...
TODO: In =modux-themes-after-load-theme-hook=, disable and enable =hl-todo= (if it
was enabled). See [[https://github.com/tarsius/hl-todo/discussions/85][GitHub discussion]].
