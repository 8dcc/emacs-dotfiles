...
Set of functions for converting [[https://www.pcre.org/original/doc/html/pcrepattern.html][PCRE]] regular expressions into [[https://www.gnu.org/software/emacs/manual/html_node/emacs/Regexps.html][Emacs regexps]] and
viceversa.

We enable the global PCRE mode (experimental according to the owner) for using
PCRE regex syntax in all emacs commands.
...
Personal package for aligning text. Uses a =straight.el= recipe.
